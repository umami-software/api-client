...
var nextBasics = require('next-basics');
...
var UmamiApiClient = (function () {
    function UmamiApiClient(options) {
        ...
        this.secret = nextBasics.hash(secret);
        this.apiKey = apiKey;
        if (userId) {
    ...
    UmamiApiClient.prototype.setAuthToken = function (data) {
        this.authToken = nextBasics.createSecureToken(data, this.secret);
    };
    ...
    UmamiApiClient.prototype.get = function (url, params, headers) {
        var dest = nextBasics.buildUrl("".concat(this.apiEndpoint, "/").concat(url), params);
        log("GET ".concat(dest), params, headers);
        return nextBasics.httpGet(dest, undefined, __assign({}, this.getHeaders(headers)));
    };
    UmamiApiClient.prototype.post = function (url, data, headers) {
        ...
        return nextBasics.httpPost(dest, data, this.getHeaders(headers));
    };
    UmamiApiClient.prototype.put = function (url, params, headers) {
        var dest = "".concat(this.apiEndpoint, "/").concat(url);
        log("PUT ".concat(dest), params, headers);
        return nextBasics.httpPut(dest, params, this.getHeaders(headers));
    };
    UmamiApiClient.prototype.del = function (url, params, headers) {
        var dest = nextBasics.buildUrl("".concat(this.apiEndpoint, "/").concat(url), params);
        log("DELETE ".concat(dest), params, headers);
        return nextBasics.httpDelete(dest, undefined, this.getHeaders(headers));
    };
...
exports.UmamiApiClient = UmamiApiClient;
